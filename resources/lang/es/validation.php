...
return [
    ...
    | utilizados por el validador. Algunas de estas reglas tienen múltiples versiones
    | como "size" entre otras. Siéntase libre de ajustarlas aquí.
    |
    */
    ...
    | de posición de atributos con algo más legible por el usuario, como "E-mail Address"
    | en lugar de "email". Esto simplemente nos ayuda a hacer los mensajes un poco más limpios.
    |
    */
